                ...
                <div className="w-full md:w-2/12">
                  <div className="row flex-row md:flex-col justify-evenly md:justify-center items-end gap-y-4">
                    {product.images.map((img, idx) => (
                      <img src={img} alt={product.title} key={idx} className="w-[170px] aspect-[170/138]"/>
                    ))}
                  </div>
                </div>
                <div className="w-full md:w-5/12">
                  <div>
                    <img src={product.imageCover} alt={product.title} className="w-full md:w-[500px] aspect-[500/600] mx-auto" />
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="row justify-between items-center mt-6 gap-y-2">
                      <div className="rounded flex">
                        ...
                        <p className="text-xl px-[34px] border-y-2 leading-8">2</p>
